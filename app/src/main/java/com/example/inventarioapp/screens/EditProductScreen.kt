...
@Composable
fun EditProductScreen(navController: NavController, productId: String?, viewModel: ProductViewModel = viewModel()){
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.menu_edit_product)) },
                navigationIcon = {
                    Icon(
